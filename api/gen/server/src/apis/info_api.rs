...
pub async fn health_get(configuration: &configuration::Configuration, ) -> Result<models::HealthResponse, Error<HealthGetError>> {
...
pub async fn version_get(configuration: &configuration::Configuration, ) -> Result<models::VersionResponse, Error<VersionGetError>> {
