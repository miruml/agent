...
impl Principal {
    pub fn new(object: Object, id: String, name: String, r#type: models::PrincipalType, api_key: Option<models::ApiKey>, device: Option<models::Device>, user: Option<models::User>) -> Principal {
        Principal {
            object,
            id,
            name,
            r#type,
            api_key: if let Some(x) = api_key {Some(Box::new(x))} else {None},
