...
impl ConfigSchema {
    pub fn new(object: Object, id: String, version: i32, digest: String, created_at: String, created_by_id: Option<String>, config_type_id: String, created_by: Option<models::User>, schema: Option<serde_json::Value>, config_type: Option<models::ConfigType>, config_schema_git_commits: Option<models::ConfigSchemaGitCommitList>, overrides: Option<models::OverrideList>) -> ConfigSchema {
        ConfigSchema {
            object,
            id,
            version,
