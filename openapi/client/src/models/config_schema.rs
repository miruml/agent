...
impl ConfigSchema {
    pub fn new(object: Object, id: String, version: i32, digest: String, created_at: String, created_by_id: Option<String>, config_id: String, created_by: Option<models::User>, schema: Option<serde_json::Value>, config: Option<models::Config>, config_schema_git_commits: Option<models::ConfigSchemaGitCommitList>, overrides: Option<models::OverrideList>) -> ConfigSchema {
        ConfigSchema {
            object,
            id,
            version,
            ...
            schema,
            config: if let Some(x) = config {Some(Box::new(x))} else {None},
