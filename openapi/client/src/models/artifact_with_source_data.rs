...
pub struct ArtifactWithSourceData {
    #[serde(rename = "object")]
    pub object: Object,
    #[serde(rename = "id")]
    pub id: String,
...
impl ArtifactWithSourceData {
    pub fn new(
        ...
        registry_source: Option<models::RegistrySource>,
        github_source: Option<models::GitHubSource>,
        github_source_data: Option<models::GitHubSourceData>,
        ...
        ArtifactWithSourceData {
            ...
            registry_source: registry_source.map(Box::new),
            github_source: github_source.map(Box::new),
            github_source_data: github_source_data.map(Box::new),
        }
    }
}
///
