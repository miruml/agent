...
impl Client {
    pub fn new(object: Object, id: String, name: String, created_at: String, updated_at: String, created_by_id: Option<String>, updated_by_id: Option<String>, created_by: Option<models::User>, updated_by: Option<models::User>, client_tags: Option<models::ClientTagPaginatedList>) -> Client {
        Client {
            object,
            id,
            name,
            ...
            client_tags: if let Some(x) = client_tags {Some(Box::new(x))} else {None},
        }
    }
}
/// 
