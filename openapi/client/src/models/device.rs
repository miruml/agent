...
pub struct Device {
    ...
    #[serde(rename = "group")]
    pub group: Box<models::BaseGroup>,
}

impl Device {
    pub fn new(object: Object, id: String, name: String, hardware: models::HardwareType, operating_system: Option<String>, architecture: Option<String>, status: models::DeviceStatus, last_reported_status: String, miru_version: Option<String>, created_at: String, synced_at: String, workspace_id: String, group: models::BaseGroup) -> Device {
        Device {
            object,
            id,
            name,
