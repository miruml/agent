...
impl ComposeFileImage {
    pub fn new(object: Object, compose_reference: String, image_uri: String, repository_uri: String, registry_url: String, registry_type: String, name: String, digest: String, tag: String, is_image_valid: bool, is_repository_valid: bool, error: String) -> ComposeFileImage {
        ComposeFileImage {
            object,
            compose_reference,
            image_uri,
