...
impl BaseDevice {
    /// A device object
    pub fn new(object: Object, id: String, name: String, hardware: models::HardwareType, operating_system: Option<String>, architecture: Option<String>, status: models::DeviceStatus, last_reported_status: String, miru_version: Option<String>, created_at: String, synced_at: String, workspace_id: String) -> BaseDevice {
        BaseDevice {
            object,
            id,
            name,
