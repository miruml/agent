...
impl BackendConcreteConfig {
    pub fn new(object: Object, id: String, created_at: Option<String>, client_id: String, config_schema_id: String, concrete_config: Option<serde_json::Value>) -> BackendConcreteConfig {
