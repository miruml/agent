...
impl BaseDeployment {
    pub fn new(object: Object, id: String, device_id: String, status: models::DeploymentStatus, activity_status: models::DeploymentActivityStatus, error_status: models::DeploymentErrorStatus, target_status: models::DeploymentTargetStatus, created_at: String, downloading_at: Option<String>, downloaded_at: Option<String>, booting_at: Option<String>, active_at: Option<String>, stopping_at: Option<String>, stopped_at: Option<String>, removing_at: Option<String>, archived_at: Option<String>, cooldown_ends_at: String) -> BaseDeployment {
        BaseDeployment {
            object,
            id,
            device_id,
