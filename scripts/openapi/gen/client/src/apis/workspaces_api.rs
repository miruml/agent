...
pub async fn get_workspace(configuration: &configuration::Configuration, ) -> Result<models::Workspace, Error<GetWorkspaceError>> {
...
pub async fn update_workspace(configuration: &configuration::Configuration, update_workspace_request: models::UpdateWorkspaceRequest) -> Result<models::Workspace, Error<UpdateWorkspaceError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_update_workspace_request = update_workspace_request;
    ...
    req_builder = req_builder.json(&p_update_workspace_request);
