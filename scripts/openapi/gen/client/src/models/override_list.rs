...
impl OverrideList {
    pub fn new(object: Object, total_count: i64, limit: i32, offset: i32, next: Option<String>, previous: Option<String>, has_more: bool, data: Vec<models::Override>) -> OverrideList {
        OverrideList {
            object,
            total_count,
            limit,
