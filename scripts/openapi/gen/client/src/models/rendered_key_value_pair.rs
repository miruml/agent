...
pub struct RenderedKeyValuePair {
    ...
    #[serde(rename = "missing_value_explanation", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "override_key_value_pair_id", deserialize_with = "Option::deserialize")]
    pub override_key_value_pair_id: Option<String>,
    #[serde(rename = "override_key_value_pair", deserialize_with = "Option::deserialize")]
...
impl RenderedKeyValuePair {
    pub fn new(object: Object, value_exists: bool, value: Option<serde_json::Value>, value_source: Option<models::RenderedKeyValuePairValueSource>, config_schema_path: Vec<String>, is_valid: bool, validation_error: Option<models::Error>, override_key_value_pair_id: Option<String>, override_key_value_pair: Option<models::OverrideKeyValuePair>, tag_id: Option<String>, tag: Option<models::Tag>) -> RenderedKeyValuePair {
        RenderedKeyValuePair {
            ...
            config_schema_path,
            is_valid,
            validation_error: if let Some(x) = validation_error {Some(Box::new(x))} else {None},
            override_key_value_pair_id,
            override_key_value_pair: if let Some(x) = override_key_value_pair {Some(Box::new(x))} else {None},
            tag_id,
