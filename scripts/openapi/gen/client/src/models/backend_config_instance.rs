...
impl BackendConfigInstance {
    pub fn new(object: Object, id: String, created_at: String, device_id: String, config_schema_id: String, config_instance: Option<serde_json::Value>) -> BackendConfigInstance {
