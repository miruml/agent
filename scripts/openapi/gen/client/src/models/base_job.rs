...
impl BaseJob {
    pub fn new(object: Object, id: String, name: String, r#type: models::JobPurpose, job_template_id: Option<String>, runs: models::BaseJobRunList, created_by: Option<models::User>, created_at: String, workspace_id: String) -> BaseJob {
        BaseJob {
            object,
            id,
            name,
