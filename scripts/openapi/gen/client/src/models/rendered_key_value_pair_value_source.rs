...
impl std::fmt::Display for RenderedKeyValuePairValueSource {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        match self {
            ...
            Self::RENDERED_KVP_VALUE_SOURCE_TAG_TYPE_SCHEMA_DEFAULT => write!(f, "tag_type_schema_default"),
            Self::RENDERED_KVP_VALUE_SOURCE_CONFIG_SCHEMA_DEFAULT => write!(f, "config_schema_default"),
        }
    }
}
