...
use miru_agent::http::query::build_query_params;
...
pub mod build_query_params_func {
    ...
    async fn pagination() {
        ...
        let query_params = build_query_params(None, None, &pagination);
    ...
    async fn search() {
        ...
        let query_params = build_query_params(search_query, None, &pagination);
    ...
    async fn expand() {
        ...
        let query_params = build_query_params(None, expand_query, &pagination);
