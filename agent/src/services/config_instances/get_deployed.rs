...
pub struct GetDeployedArgs {
    pub device_id: String,
    pub config_type_slug: String,
    pub config_schema_digest: String,
}

impl GetDeployedArgsI for GetDeployedArgs {
    fn device_id(&self) -> &str {
        &self.device_id
    }
    fn config_type_slug(&self) -> &str {
...
pub async fn get_deployed<GetDeployedArgsT: GetDeployedArgsI, HTTPClientT: ConfigSchemasExt>(
    args: &GetDeployedArgsT,
    syncer: &Syncer,
...
async fn fetch_config_schema_id<
    GetDeployedArgsT: GetDeployedArgsI,
